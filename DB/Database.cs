/****************************************************************
'* Change history : #001 2017/11/24 HiepNH4
'* : add param 
'*********************************************************************************/
...
namespace API_WebService
{
    public class Database
    {
        public static DataSet ProcessRequest(RequestCollection requests, string ConnectionStringName = "DB")
        {
